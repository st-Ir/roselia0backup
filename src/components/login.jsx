          ...
          <div className="flex items-center justify-center space-x-4 mb-6">
            {provider && (
              <div className="flex items-center">
                {provider === 'github' ? (
                 <svg className="w-4 h-4 text-gray-400 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-github">
